        ...
        if (!bWait) {
            ...
            if (fNowTime >= fTime && fNowTime < fTime + fWaitTime) {
                ...
                if (!bSe) {
                    ...
                    SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTIN, false);

                    switch (nNumber) {
                    case 0:
                        SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTINHARE, false);
                        break;
                    case 1:
                        SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTINAME, false);
                        break;
                    case 2:
                        SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTINKAMINARI, false);
                        break;
                    case 3:
                        SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTINKAZE, false);
                        break;
                    case 4:
                        SoundManager.Instance.PauseSE (SoundManager.eSeValue.SE_CUTINFRIEND, false);
                        break;
                    }
                }
