...
public class TurnData : MonoBehaviour {
	...
	public tTurnData GetTurnData() { 
        ...
        /*Debug.Log("Red" + data.Red.fNumber);
        Debug.Log("Blue" + data.Blue.fNumber);
        Debug.Log("Green" + data.Green.fNumber);
        Debug.Log("Yellow" + data.Yellow.fNumber);*/
		...
		for (int i = 0; i < DrowDataList.Count; i++) {
			...
			case UnoStruct.eColor.COLOR_RED:
				...
				//Debug.Log ("DrowRed : " + DrowDataList[i].fAmount);
				break;
			case UnoStruct.eColor.COLOR_BLUE:
				data.Blue.fNumber *= DrowDataList[i].fAmount;
                //Debug.Log("DrowBlue : " + DrowDataList[i].fAmount);
				break;
			case UnoStruct.eColor.COLOR_GREEN:
			...
			case UnoStruct.eColor.COLOR_YELLOW:
                ...
                //Debug.Log("DrowYellow : " + DrowDataList[i].fAmount);
				break;
